...
Construct a (parameterised) quantum circuit into a pure [JAX](https://github.com/google/jax) function that
...
for runtime speedups, automatic differentiation and support for GPUs/TPUs.
